...
static const int LAST_PURE_POW_BLOCK = 64800;	
...
static const int64_t MAX_MONEY = 14000000 * COIN;
static const double TAXATION_PERCENTAGE = 0.01;
static const int64_t MAX_MINT_PROOF_OF_STAKE_STABLE = 0.05 * COIN;	
...
static const uint256 hashGenesisBlock("00000c6ad151c357f3d79eb6be835ff0d7557ce667f7c00bd70e5b198e943812");
static const uint256 hashGenesisBlockTestNet("00000c6ad151c357f3d79eb6be835ff0d7557ce667f7c00bd70e5b198e943812");
...
public:
    ...
    {
        // Wonderful8Coin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Wonderful8Coin: get transaction coin age
...
public:
    ...
    // Wonderful8Coin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Wonderful8Coin: two types of block: proof-of-work or proof-of-stake
    ...
    // Wonderful8Coin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Wonderful8Coin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Wonderful8Coin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Wonderful8Coin: block index flags
    enum  
    {
